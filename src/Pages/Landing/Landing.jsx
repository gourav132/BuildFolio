  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Navigation */}
        <nav className="flex items-center justify-between py-6 px-2 sm:px-0">
          <motion.div
        ...
        {/* Hero Section */}
        <section className="relative py-14 sm:py-20 text-center">
          <motion.div
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6 sm:mb-8 leading-[1.1] tracking-tight"
          >
            Build Your Professional
            <span className="block bg-gradient-to-r from-purple-400 via-pink-500 to-blue-400 bg-clip-text text-transparent mt-2">
              Portfolio
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-base sm:text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap justify-center items-center gap-3 sm:gap-6 text-gray-400 text-xs sm:text-sm"
          >
        ...
        <section className="relative py-12 sm:py-20">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Why Choose BuildFolio?</h2>
        ...
        {/* Stats Section */}
        <section className="relative py-12 sm:py-20 border-y border-gray-800/50">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 sm:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-2xl sm:text-3xl font-bold mb-2 bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                  {stat.number}
                </div>
                <div className="text-gray-400 text-xs sm:text-base font-medium">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </section>
        ...
        <section className="relative py-12 sm:py-20">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="relative bg-gradient-to-r from-purple-600/20 to-blue-600/20 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 sm:p-12 text-center overflow-hidden"
          >
            {/* Background Pattern */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(120,119,198,0.1),transparent_50%)]"></div>

            <div className="relative z-10">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to Build Your Portfolio?</h2>
