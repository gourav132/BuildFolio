...
const Hero = () => {
  const { profile, synopsis, loading } = usePortfolioData();
  ...
  if (loading) {
    return <div className="w-full h-screen bg-primary flex items-center justify-center">
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-6 sm:px-16 flex items-center justify-center">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            ...
            >
              {synopsis?.intro || "I create exceptional digital experiences that combine cutting-edge technology with beautiful design. Passionate about building scalable solutions and bringing ideas to life."}
            </motion.p>
            ...
            >
              <a href="#works" className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-center font-semibold rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-sm">
                View My Work
              </a>
            ...
            >
              {socialLinks.length > 0 && <span className="text-white/60 text-xs font-medium">Follow me:</span>}
