...
const About = () => {
  const { synopsis, loading } = usePortfolioData();

  if (loading) {
    return <div className="text-white text-center">Loading intel...</div>
  }

  const servicesList = synopsis?.services && synopsis.services.length > 0 ? synopsis.services : defaultServices;
  ...
  return (
    <div className="relative">
      ...
      <div className="relative z-10">
        ...
        {/* Services Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-white font-['Space_Grotesk',sans-serif]">
